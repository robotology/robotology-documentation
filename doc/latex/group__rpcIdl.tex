...
Example to show idl usage. Version\+:1.\+0.  
...
\begin{DoxyItemize}
\item /rpc\+Idl/server \mbox{[}rpc-\/server\mbox{]}\+: Command port . This service is described in \mbox{\hyperlink{classIRpcServer}{I\+Rpc\+Server}} (I\+Rpc\+Server.\+thrift)
\item /rpc\+Idl/client \mbox{[}rpc-\/client\mbox{]}\+: Control remote object . This service is described in \mbox{\hyperlink{classIRpcServer}{I\+Rpc\+Server}} (I\+Rpc\+Server.\+thrift) 
\end{DoxyItemize}