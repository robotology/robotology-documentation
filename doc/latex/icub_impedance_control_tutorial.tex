...
\hypertarget{icub_impedance_control_tutorial}{}\label{icub_impedance_control_tutorial}\index{Getting accustomed with torque/impedance interfaces@{Getting accustomed with torque/impedance interfaces}}
...
yarp\+::dev\+::\+IInteraction\+Control\hypertarget{icub_tutorial_module_sec_intro}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{icub_tutorial_module_sec_intro}
Prerequisites, see \doxysectlink{icub_motor_control_tutorial}{Getting accustomed with motor interfaces}{0}

The code described in this tutorial can be found at \doxylink{tutorial__arm__joint__impedance_8cpp}{src/motor\+Control\+Impedance/tutorial\+\_\+arm\+\_\+joint\+\_\+impedance.\+cpp} ~\newline
The example is based on the previous tutorial \doxylink{tutorial__arm_8cpp}{src/motor\+Control\+Basic/tutorial\+\_\+arm.\+cpp}
...
\DoxyCodeLine{\mbox{\hyperlink{WholeBodyPlayerModule_8h_a055865842672bfeb446ff98a1e9104aba444bcb3a3fcf8389296c49467f27e1d6}{ok}}\ =\ \mbox{\hyperlink{WholeBodyPlayerModule_8h_a055865842672bfeb446ff98a1e9104aba444bcb3a3fcf8389296c49467f27e1d6}{ok}}\ \&\&\ robotDevice.view(encs);}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{if}\ (!\mbox{\hyperlink{WholeBodyPlayerModule_8h_a055865842672bfeb446ff98a1e9104aba444bcb3a3fcf8389296c49467f27e1d6}{ok}})\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}}\ =\ 0;}
\DoxyCodeLine{pos-\/>getAxes(\&jnts);}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_aa48897549d21fee7c0824a33753804e2}{tmp}}.resize(jnts);}
\DoxyCodeLine{encoders.resize(jnts);}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\textcolor{keywordflow}{for}\ (i\ =\ 0;\ i\ <\ \mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}};\ i++)\ \{}
...
\DoxyCodeLine{\ \ \ \ pos-\/>setRefSpeed(i,\ tmp[i]);}
\DoxyCodeLine{\}}
...
which reads the values of the motor encoders into a vector of doubles of size \textquotesingle{}\textquotesingle{}jnts\textquotesingle{}\textquotesingle{}.\hypertarget{icub_motor_control_tutorial_sec_position}{}\doxysection{\texorpdfstring{Position control}{Position control}}\label{icub_motor_control_tutorial_sec_position}
First do\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ i;}
\DoxyCodeLine{\textcolor{keywordflow}{for}\ (i\ =\ 0;\ i\ <\ \mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}};\ i++)\ \{}
...
where \textquotesingle{}\textquotesingle{}command\+\_\+position\textquotesingle{}\textquotesingle{} is the desired position. This starts a movement of all axes toward the desired position.\hypertarget{icub_impedance_control_tutorial_sec_torque_reading}{}\doxysection{\texorpdfstring{Reading the torques of a joint}{Reading the torques of a joint}}\label{icub_impedance_control_tutorial_sec_torque_reading}
...
\end{DoxyCode}
\hypertarget{icub_impedance_control_tutorial_sec_impedance}{}\doxysection{\texorpdfstring{Using different control modes\+:  Position Control}{Using different control modes:  Position Control}}\label{icub_impedance_control_tutorial_sec_impedance}
...
An Impedance\+Velocity control mode is also available. In this control modality you can use vel-\/\texorpdfstring{$>$}{>}Velocity\+Move() command in order to command a velocity while mantaining the impedance specified with the iimp-\/\texorpdfstring{$>$}{>}set\+Impedance(joint, stiffness, damping, dorce\+\_\+offset) command.\hypertarget{icub_impedance_control_tutorial_sec_torque_control}{}\doxysection{\texorpdfstring{Using different control modes\+: Torque Control}{Using different control modes: Torque Control}}\label{icub_impedance_control_tutorial_sec_torque_control}
...
NOTE4\+: If your application changes the control mode/interaction mode of one joint, it\textquotesingle{}s good practice to reset it to the previous modality when your application quits.\hypertarget{icub_motor_control_tutorial_sec_closing}{}\doxysection{\texorpdfstring{Closing the device}{Closing the device}}\label{icub_motor_control_tutorial_sec_closing}
...
\end{DoxyCode}
\hypertarget{icub_motor_control_tutorial_sec_more_interfaces}{}\doxysection{\texorpdfstring{More interfaces}{More interfaces}}\label{icub_motor_control_tutorial_sec_more_interfaces}
To read more about the interfaces that are available in YARP read the \href{http://wiki.icub.org/yarpdoc/namespaceyarp_1_1dev.html}{\texttt{ doxygen online documentation}} and in the \href{http://wiki.icub.org/wiki/File:ICub_Control_Modes_1_1.pdf}{\texttt{ YARP Control Modes documentation}}.\hypertarget{icub_tutorial_module_sec_code}{}\doxysection{\texorpdfstring{Code}{Code}}\label{icub_tutorial_module_sec_code}
See code in\+: \doxylink{tutorial__arm__joint__impedance_8cpp}{src/motor\+Control\+Impedance/tutorial\+\_\+arm\+\_\+joint\+\_\+impedance.\+cpp} 