...
and typing\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} \mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}} 0 -\/60}
\end{DoxyCode}
...
In Y\+A\+RP, camera images are sent from one program to another using ports. In C++, we can create a port for reading or writing images like this\+:
...
This means \char`\"{}make a port with buffering for sending/receiving images in R\+G\+B format\char`\"{}.
...
\DoxyCodeLine{    ImageOf<PixelRgb> *\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}} = imagePort.read();  \textcolor{comment}{// read an image}}
\DoxyCodeLine{    \textcolor{keywordflow}{if} (\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}!=NULL) \{ \textcolor{comment}{// check we actually got something}}
\DoxyCodeLine{       printf(\textcolor{stringliteral}{"We got an image of size \%dx\%d\(\backslash\)n"}, \mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>width(), \mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>height());}
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
...
This creates a basic C\+Make\+Lists.\+txt project file that is good enough to compile most simple programs. Run cmake in this directory, and compile. You will get a program called \char`\"{}yarpy\char`\"{} (you can and should change this name by editing the C\+Make\+Lists.\+txt file). If you run it, you should see a port called \char`\"{}/tutorial/image/in\char`\"{} being created. ~\newline
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespaceyarp}{yarp}} connect <name of image port> /tutorial/\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}/in}
\end{DoxyCode}


for example, for the simulator, it would be something like\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespaceyarp}{yarp}} connect /icubSim/cam/left /tutorial/\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}/in}
\end{DoxyCode}
...
\DoxyCodeLine{       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \mbox{\hyperlink{compute__ekf__sym_8m_abe119338ba11d7fd166333a3941bc2c4}{x}}=0; \mbox{\hyperlink{compute__ekf__sym_8m_abe119338ba11d7fd166333a3941bc2c4}{x}}<\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>width(); \mbox{\hyperlink{compute__ekf__sym_8m_abe119338ba11d7fd166333a3941bc2c4}{x}}++) \{}
\DoxyCodeLine{         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \mbox{\hyperlink{show__eyes__axes_8m_a2fb1c5cf58867b5bbc9a1b145a86f3a0}{y}}=0; \mbox{\hyperlink{show__eyes__axes_8m_a2fb1c5cf58867b5bbc9a1b145a86f3a0}{y}}<\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>height(); \mbox{\hyperlink{show__eyes__axes_8m_a2fb1c5cf58867b5bbc9a1b145a86f3a0}{y}}++) \{}
\DoxyCodeLine{           PixelRgb\& pixel = \mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>pixel(\mbox{\hyperlink{compute__ekf__sym_8m_abe119338ba11d7fd166333a3941bc2c4}{x}},\mbox{\hyperlink{show__eyes__axes_8m_a2fb1c5cf58867b5bbc9a1b145a86f3a0}{y}});}
...
\DoxyCodeLine{       \}}
\DoxyCodeLine{       \textcolor{keywordflow}{if} (ct>(\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>width()/20)*(\mbox{\hyperlink{iCub__Sim_8cpp_aa73601f944838ffac2fa4d3e298a6ef4}{image}}-\/>height()/20)) \{}
...
Now that we have a target, let\textquotesingle{}s output it. We can output it as a Y\+A\+RP Vector for example, using a port like this\+:
...
\begin{DoxyCode}{0}
\DoxyCodeLine{printf(\textcolor{stringliteral}{"Best guess at blue target: \%g \%g\(\backslash\)n"}, xMean, yMean);}
\DoxyCodeLine{Vector\& \mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}} = targetPort.prepare();}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}.resize(3);}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[0] = xMean;}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[1] = yMean;}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[2] = 1;       \textcolor{comment}{// a confidence value, always good practice to add.  In this case, we pretend to be very confident}}
...
\DoxyCodeLine{Vector\& \mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}} = targetPort.prepare();}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}.resize(3);}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[0] = 0;}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[1] = 0;}
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_ac8859e8c1ce357c4c8b37bbb1936ba1c}{v}}[2] = 0;}
\DoxyCodeLine{targetPort.write();  \textcolor{comment}{// send our data}}
\end{DoxyCode}
...
Now we need to drive the motors (see \mbox{\hyperlink{icub_motor_control_tutorial}{Getting accustomed with motor interfaces}}). For this, we need the Y\+A\+RP device classes, so we add another header file at the start of our program\+:
...
\DoxyCodeLine{IPositionControl *\mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}};}
\DoxyCodeLine{IVelocityControl *vel;}
\DoxyCodeLine{IEncoders *enc;}
\DoxyCodeLine{robotHead.view(mod);}
\DoxyCodeLine{robotHead.view(\mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}});}
\DoxyCodeLine{robotHead.view(vel);}
\DoxyCodeLine{robotHead.view(enc);}
\DoxyCodeLine{\textcolor{keywordflow}{if} (\mbox{\hyperlink{rendering_8cpp_a26a9807262dc858feb31c318b02fc072}{mode}}==NULL || \mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}}==NULL || vel==NULL || enc==NULL) \{}
...
\DoxyCodeLine{\mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}}-\/>getAxes(\&\mbox{\hyperlink{icub-main_2src_2tools_2simpleClient_2main_8cpp_aac40ef34e7573177f3e908c5195594a6}{jnts}});}
...
\DoxyCodeLine{  robotHead.view(vel);}
\DoxyCodeLine{  robotHead.view(enc);}
\DoxyCodeLine{  \textcolor{keywordflow}{if} (\mbox{\hyperlink{iCub__Sim_8cpp_a17f77f0450a3c3dd28cd3715400ffdae}{pos}}==NULL || vel==NULL || enc==NULL) \{}
\DoxyCodeLine{    printf(\textcolor{stringliteral}{"Cannot get interface to robot head\(\backslash\)n"});}
\DoxyCodeLine{    robotHead.close();}
\DoxyCodeLine{    \textcolor{keywordflow}{return} 1;}
\DoxyCodeLine{  \}}
