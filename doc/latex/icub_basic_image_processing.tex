...
\hypertarget{icub_basic_image_processing}{}\label{icub_basic_image_processing}\index{Basic Image Processing@{Basic Image Processing}}
...
To choose a visual target and fixate it. For simplicity, the target shall be "{}blueish stuff"{}, and we\textquotesingle{}ll work on the simulator.

So if the simulated robot sees something like this\+:



\hypertarget{icub_basic_image_processing_sec_programs}{}\doxysection{\texorpdfstring{Programs to write}{Programs to write}}\label{icub_basic_image_processing_sec_programs}
...
(this should turn the eyes 60 degrees downward).\hypertarget{icub_basic_image_processing_sec_find_location}{}\doxysection{\texorpdfstring{Find Location}{Find Location}}\label{icub_basic_image_processing_sec_find_location}
...
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{icub-tutorials_2src_2anyRobotCartesianInterface_2src_2fakeRobot_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}()\ \{}
...
You can compile this any way you like. One quick way to do it is to go into the directory where you saved this program (in a file called for example "{}find\+\_\+location.\+cpp"{}) and type\+:
...
This creates a basic CMake\+Lists.\+txt project file that is good enough to compile most simple programs. Run cmake in this directory, and compile. You will get a program called "{}yarpy"{} (you can and should change this name by editing the CMake\+Lists.\+txt file). If you run it, you should see a port called "{}/tutorial/image/in"{} being created. ~\newline
...
\end{DoxyCode}
\hypertarget{icub_basic_image_processing_sec_look_at}{}\doxysection{\texorpdfstring{Look at Location}{Look at Location}}\label{icub_basic_image_processing_sec_look_at}
...
Now we need to drive the motors (see \doxysectlink{icub_motor_control_tutorial}{Getting accustomed with motor interfaces}{0}). For this, we need the YARP device classes, so we add another header file at the start of our program\+:
...
\DoxyCodeLine{setpoints.resize(jnts);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ enable\ velocity\ control\ mode}}
\DoxyCodeLine{vector<int>\ modes(jnts,VOCAB\_CM\_VELOCITY);}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i=0;\ i<\mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}};\ i++)\ \{}
...
The robot head should move to an extreme "{}diagonal"{} location. This helps us figure out which signs for velocity move the robot\textquotesingle{}s view in which direction. Here\textquotesingle{}s an actual working tracker\+: 
\begin{DoxyCode}{0}
...
\doxylink{findLocation_8cpp}{src/image\+Processing/find\+Location.\+cpp} \doxylink{lookAtLocation_8cpp}{src/image\+Processing/look\+At\+Location.\+cpp} 