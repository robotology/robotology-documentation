\doxysubsubsection{imu\+Filter}
\hypertarget{group__icub__imuFilter}{}\label{group__icub__imuFilter}\index{imuFilter@{imuFilter}}
...
At startup it tries to attach directly to the IMU devcice of the specified robot or through a Multiple\+Analog\+Sensors\+Client(using the subdevice mechanism).\hypertarget{group__tutorial__perceptiveModels_parameters_sec}{}\doxysubsubsubsection{\texorpdfstring{Parameters}{Parameters}}\label{group__tutorial__perceptiveModels_parameters_sec}
--name("{}imu\+Filter"{}) // module\textquotesingle{}s name; all the open ports will be tagged with the prefix /name.
...
--proxy-\/local // Required only if run with multipleanalgosensorsclient as subdevice, port prefix of the multipleanalogsensorsclinet to be created.\hypertarget{group__icub__imuFilter_deployment}{}\doxysubsubsubsubsection{\texorpdfstring{how to run the imu\+Filter}{how to run the imuFilter}}\label{group__icub__imuFilter_deployment}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{<!-\/-\/\ The\ name\ of\ the\ element\ can\ be\ any\ string\ (we\ use\ SetOfIMUs\ to\ better\ express\ its\ nature).}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Its\ value\ must\ match\ the\ device\ name\ in\ the\ corresponding\ body\_part-\/jx\_y-\/inertials.xml\ file}}
...
yarpdev --device imu\+Filter --subdevice multipleanalogsensorsclient --proxy-\/remote MASServer\+Name --proxy-\/local MASClient\+Name\hypertarget{group__icub__imuFilter_usage_sec}{}\doxysubsubsubsection{\texorpdfstring{Usage}{Usage}}\label{group__icub__imuFilter_usage_sec}
...
Another way is reading through the streaming port $<$name$>$/measures\+:o.\hypertarget{group__tutorial__ationPrimitives_portsc_sec}{}\doxysubsubsubsection{\texorpdfstring{Ports Created}{Ports Created}}\label{group__tutorial__ationPrimitives_portsc_sec}
