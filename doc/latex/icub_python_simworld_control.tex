...
\hypertarget{icub_python_simworld_control}{}\label{icub_python_simworld_control}\index{Controlling the iCub Simulator from Python@{Controlling the iCub Simulator from Python}}
\begin{DoxyAuthor}{Author}
Marek Rucinski
\end{DoxyAuthor}
\hypertarget{icub_python_simworld_control_sec_goal}{}\doxysection{\texorpdfstring{Goal}{Goal}}\label{icub_python_simworld_control_sec_goal}
This tutorial shows how to control the \doxylink{namespaceiCub}{i\+Cub} simulator via YARP bindings for Python. Since there is no dedicated \doxylink{namespaceiCub}{i\+Cub} simulator API available, this has to be achieved via the YARP RPC mechanism. Therefore, this tutorial should also give you a general idea on how to use the RPC interfaces from Python.

It is assumed that you have already compiled or installed the Python bindings. This tutorial assumes basic knowledge of how YARP works in C++, familiarity with YARP RPC mechanism, the specific RPC interface of the \doxylink{namespaceiCub}{i\+Cub} simulator (described in the simulator README) as well as some basic knowledge of Python, it\textquotesingle{}s essential packages and functions.

This tutorial has the form of a small Python module which implements a World\+Controller class used to communicate with the \doxylink{namespaceiCub}{i\+Cub} simulator. Full code of this module can be found in \doxylink{python__simworld__control_8py}{python/python\+\_\+simworld\+\_\+control.\+py}\hypertarget{icub_python_simworld_control_sec_start}{}\doxysection{\texorpdfstring{Module initialisation}{Module initialisation}}\label{icub_python_simworld_control_sec_start}
...
\DoxyCodeLine{import\ yarp}
\DoxyCodeLine{}
\DoxyCodeLine{yarp.Network.init()\ \#\ Initialise\ YARP}

\end{DoxyCode}


Placing the call to yarp.\+Network.\+init() directly in the module code (as opposed to putting it inside some function defined later in the module) ensures that YARP is initialised as soon as the module is imported.\hypertarget{icub_python_simworld_control_sec_wctl}{}\doxysection{\texorpdfstring{World\+Controller class}{WorldController class}}\label{icub_python_simworld_control_sec_wctl}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}}.\_objects\ =\ [\ ]}
...
As a starting point, let\textquotesingle{}s take the "{}world del all"{} command which removes all objects created in the simulator. This is a simple command which takes no arguments, therefore the code is also quite simple\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{def\ \_prepare\_del\_all\_command(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}}):}
...
Now for something a little more interesting. RPC interface of the simulator allows creating various objects (spheres, cylinders, etc.) in the simulated world. Let\textquotesingle{}s define a function to prepare the "{}world mk"{} command Bottle\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{def\ \_prepare\_create\_command(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}},\ obj,\ size,\ location,\ colour):}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{def\ create\_object(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}},\ obj,\ size,\ location,\ colour):}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ len(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}}.\_objects)\ -\/\ 1}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{else}:}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ -\/1\ \#\ \mbox{\hyperlink{debugFunctions_8cpp_a7a3172cc98e93d8eadfb9ab30373799e}{error}}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{def\ \_prepare\_move\_command(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}},\ obj,\ obj\_id,\ location):}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{def\ \_prepare\_get\_command(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}},\ obj,\ obj\_id):}
...
\DoxyCodeLine{\ \ \ \ else:}
\DoxyCodeLine{\ \ \ \ \ \ \ \ return\ None\ \#\ An\ \mbox{\hyperlink{debugFunctions_8cpp_a7a3172cc98e93d8eadfb9ab30373799e}{error}}\ occured}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{def\ \_\_del\_\_(\mbox{\hyperlink{firmwareupdatercore_8cpp_a396f1276c4c0cd4c8ea515f853c8494f}{self}}):}
\DoxyCodeLine{\ \ \ \ try:}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{import}\ python\_simworld\_control\ as\ psc\ \ \#\ YARP\ is\ automatically\ initalised\ now}
\DoxyCodeLine{}
\DoxyCodeLine{wc\ =\ psc.WorldController()\ \#\ you\ will\ see\ YARP\ spitting\ out\ debugging\ messages\ as\ RPC\ client\ connects\ to\ the\ server}
\DoxyCodeLine{}
\DoxyCodeLine{\#\ Let's\ create\ some\ objects...}
\DoxyCodeLine{}
\DoxyCodeLine{red\_sphere\ =\ wc.create\_object('ssph',\ [\ 0.1\ ],\ [\ -\/1,\ 1,\ 1\ ],\ [\ 1,\ 0,\ 0\ ])}
\DoxyCodeLine{green\_box\ =\ wc.create\_object('sbox',\ [\ 0.2,\ 0.2,\ 0.2\ ],\ [\ 0,\ 1,\ 1\ ],\ [\ 0,\ 1,\ 0\ ])}
\DoxyCodeLine{blue\_cylinder\ =\ wc.create\_object('scyl',\ [\ 0.1,\ 0.1\ ],\ [\ 1,\ 1,\ 1\ ],\ [\ 0,\ 0,\ 1\ ])}
\DoxyCodeLine{}
\DoxyCodeLine{\#\ ...\ move\ them\ around\ ...}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\#\ ...\ and\ ask\ for\ their\ positions\ ...}
\DoxyCodeLine{}
\DoxyCodeLine{print\ wc.get\_object\_location(green\_box)}
\DoxyCodeLine{}
\DoxyCodeLine{\#\ Now\ let's\ cleanup}
\DoxyCodeLine{}
\DoxyCodeLine{wc.del\_all()}
\DoxyCodeLine{}
\DoxyCodeLine{\#\ No,\ wait,\ I\ want\ more!}
\DoxyCodeLine{}
\DoxyCodeLine{monolith\ =\ wc.create\_object('sbox',\ [\ 0.8,\ 1.8,\ 0.2\ ],\ [\ 0,\ 0.9,\ 1\ ],\ [\ 0,\ 0,\ 0\ ])}
\DoxyCodeLine{}
\DoxyCodeLine{\#\ OK,\ this\ time\ we're\ done\ for\ good\ -\/\ delete\ the\ wc\ object,\ what\ will\ invoke\ its\ destructor}
\DoxyCodeLine{}
\DoxyCodeLine{del\ wc}
...
This file can be edited at \doxylink{python-simworld-control_8dox}{doc/python-\/simworld-\/control.\+dox} 