...
\hypertarget{application_documentation}{}\label{application_documentation}\index{Application Documentation@{Application Documentation}}
...
Replace "{}example\+Application"{} with the name of your application.
