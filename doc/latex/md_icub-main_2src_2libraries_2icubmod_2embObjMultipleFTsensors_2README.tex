...
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README}{}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README}\index{1. General info@{1. General info}}
\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md19}%
\Hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md19}%
The device\textquotesingle{}s purpose is to make it possible to connect up to {\ttfamily 4 FT} sensors to a single EMS board.\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md20}{}\doxysection{\texorpdfstring{1.\+1. Prereqisite}{1.1. Prereqisite}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md21}{}\doxysection{\texorpdfstring{2. XML configuration file}{2. XML configuration file}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md21}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{<!-\/-\/\ we\ can\ have\ as\ many\ boards\ as\ we\ want,\ }}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ but\ now\ the\ only\ good\ ones\ are\ strain\ and\ strain2.\ }}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ </\textcolor{keywordtype}{group}>}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{comment}{<!-\/-\/\ we\ can\ pick\ up\ at\ max\ 4\ sensors\ from\ the\ above\ list.\ }}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ we\ can\ specify\ parameters\ that\ are\ different\ for\ each\ sensor\ }}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ -\/\ ftPeriod\ is\ expressed\ in\ ms\ in\ the\ range\ [1,\ 250]}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ -\/\ temperaturePeriod\ is\ expressed\ in\ ms\ (but\ it\ will\ be\ used\ in\ seconds).}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ \ \ \ \ \ \ \ \ -\/\ useCalibration\ is\ boolean}}
...
ℹ️ {\ttfamily Note that all the time values are expressed in milliseconds.}\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md22}{}\doxysubsection{\texorpdfstring{2.\+1. Raw ADC data or FT data}{2.1. Raw ADC data or FT data}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md22}
...
if {\ttfamily false} raw data are logged from the correspondent sensor.\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md23}{}\doxysection{\texorpdfstring{3. Yarp output}{3. Yarp output}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md23}
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md24}{}\doxysubsection{\texorpdfstring{3.\+1. Ports}{3.1. Ports}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md24}
...
\end{DoxyCode}
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md25}{}\doxysubsection{\texorpdfstring{3.\+2. Output format}{3.2. Output format}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md25}
...
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md26}{}\doxysection{\texorpdfstring{4. Debug}{4. Debug}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md26}
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md27}{}\doxysubsection{\texorpdfstring{4.\+1. Install folder}{4.1. Install folder}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md28}{}\doxysubsection{\texorpdfstring{4.\+2. Visual studio code debugging}{4.2. Visual studio code debugging}}\label{md_icub-main_2src_2libraries_2icubmod_2embObjMultipleFTsensors_2README_autotoc_md28}
