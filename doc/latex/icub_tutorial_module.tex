...
\hypertarget{icub_tutorial_module}{}\label{icub_tutorial_module}\index{The RFModule Class@{The RFModule Class}}
In this tutorial we show more details of how to write an \doxylink{namespaceiCub}{i\+Cub} module using the module helper class.\hypertarget{icub_tutorial_module_sec_intro}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{icub_tutorial_module_sec_intro}
...
The RFModule helper class simplify writing an \doxylink{namespaceiCub}{i\+Cub} module that uses the Resource\+Finder class.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{icub-tutorials_2src_2anyRobotCartesianInterface_2src_2fakeRobot_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}(\textcolor{keywordtype}{int}\ argc,\ \textcolor{keywordtype}{char}\ *\ argv[])}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{module}.runModule(rf);\ \ \ \textcolor{comment}{//\ This\ calls\ configure(rf)\ and,\ upon\ success,\ the\ module\ execution\ begins\ with\ a\ call\ to\ updateModule()}}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{icub_tutorial_module_sec_code}{}\doxysection{\texorpdfstring{Code}{Code}}\label{icub_tutorial_module_sec_code}
