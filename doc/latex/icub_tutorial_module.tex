...
In a previous \href{http://wiki.icub.org/yarpdoc/yarp_resource_finder_tutorials.html}{\texttt{ tutorial}} we showed how to use the Resource\+Finder to organize modules parameters in \$\+Y\+A\+R\+P\+\_\+\+D\+A\+T\+A\+\_\+\+H\+O\+ME/contexts.

The R\+F\+Module helper class simplify writing an \mbox{\hyperlink{namespaceiCub}{i\+Cub}} module that uses the Resource\+Finder class.
