...
--\char`\"{}no\+\_\+head\char`\"{}/\char`\"{}no\+\_\+gaze\char`\"{}\+: the action does not affect the gaze of the robot (this parameter does not influece commands that explicitly require to move the head like L\+O\+OK).
...
{\bfseries{G\+ET}} format\+: \mbox{[}get\mbox{]} $<$request$>$ action\+: the system returns the requested element.
