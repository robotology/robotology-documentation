...
A module to replay the encoder data coming from yarpdataplayer(\href{http://yarp.it/yarpdataplayer.html}{\texttt{ http\+://yarp.\+it/yarpdataplayer.\+html}}).  
...
This module opens a remote\+\_\+controlboard (\href{http://yarp.it/classyarp_1_1dev_1_1RemoteControlBoard.html}{\texttt{ http\+://yarp.\+it/classyarp\+\_\+1\+\_\+1dev\+\_\+1\+\_\+1\+Remote\+Control\+Board.\+html}}) for each $<$part$>$ and commands it in position direct control to specific positions received by the input port related to the part.
