...
\hypertarget{icub_python_basic_motor}{}\label{icub_python_basic_motor}\index{Using Motor Control Interfaces in Python@{Using Motor Control Interfaces in Python}}
...
This tutorial shows how to use Python to interface with the \doxylink{namespaceiCub}{i\+Cub}. In particular we focus on controlling the motors using the motor control interfaces. We assume that you have already compiled or installed the Python bingings. This tutorial assume basic knowledge of how YARP works in C++. We just show how the robot C++ interface can be used in Python.

Dislaimer\+: this code does not do anything fancy with the robot. We let you have fun with the robot and Python once you know how the interface works.\hypertarget{icub_python_basic_motor_sec_python-ll}{}\doxysection{\texorpdfstring{Joint level motor control}{Joint level motor control}}\label{icub_python_basic_motor_sec_python-ll}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_a27a4e13b7da2a48a14d19a33a7e4900e}{armDriver}}\ =\ \mbox{\hyperlink{namespaceyarp}{yarp}}.PolyDriver(props)}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}}=\mbox{\hyperlink{namespacepython-motor-control_a58ae1d0a5b13a0a368838e8ced2c3289}{iPos}}.getAxes()}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{namespaceeth_1_1parser_ac2f5662a765ffbe9a0790ca81c24a838}{print}}\ \textcolor{stringliteral}{'Controlling'},\ \mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}},\ \textcolor{stringliteral}{'joints'}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#\ read\ encoders}}
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_aa4a312653eff9f950af80bbf61a3d925}{encs}}=\mbox{\hyperlink{namespaceyarp}{yarp}}.Vector(jnts)}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_ae457f2d5a66ef7a457909b6fd2f9fec3}{home}}=\mbox{\hyperlink{namespaceyarp}{yarp}}.Vector(jnts,\ \mbox{\hyperlink{namespacepython-motor-control_aa4a312653eff9f950af80bbf61a3d925}{encs}}.data())}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#initialize\ a\ new\ tmp\ vector\ identical\ to\ encs}}
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_aa48897549d21fee7c0824a33753804e2}{tmp}}=\mbox{\hyperlink{namespaceyarp}{yarp}}.Vector(jnts)}
\DoxyCodeLine{}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacepython-motor-control_a58ae1d0a5b13a0a368838e8ced2c3289}{iPos}}.positionMove(\mbox{\hyperlink{namespacepython-motor-control_aa48897549d21fee7c0824a33753804e2}{tmp}}.data())}
...
Code can be found at \doxylink{python-motor-control_8py}{python/python-\/motor-\/control.\+py}

This file can be edited at \doxylink{python-motor-control_8dox}{doc/python-\/motor-\/control.\+dox} 