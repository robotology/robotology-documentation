...
\hypertarget{module_documentation}{}\label{module_documentation}\index{Module Documentation@{Module Documentation}}
This is a template you can use to document your module.

Replace "{}example\+Module"{} with the name of your module.
...
\item Please use namespaces (see existing \doxylink{namespaceiCub}{i\+Cub} code)\+: e.\+g. \doxylink{namespaceiCub_1_1contrib}{i\+Cub\+::contrib}.
