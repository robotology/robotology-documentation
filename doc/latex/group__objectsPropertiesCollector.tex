...
{\itshape Format}\+: \mbox{[}ask\mbox{]} ((\char`\"{}prop0\char`\"{} \char`\"{}$<$\char`\"{} $<$val0$>$) $\vert$$\vert$ (\char`\"{}prop1\char`\"{} \char`\"{}$>$=\char`\"{} $<$val1$>$) ...) ~\newline
 ...
 The special command \char`\"{}\mbox{[}ask\mbox{]} 
(all)\char`\"{} returns the whole set of ids present within the database. ~\newline
...
\DoxyCodeLine{ }
\DoxyCodeLine{command: [\mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}}] ((\textcolor{keywordtype}{id} 1) (\mbox{\hyperlink{compute__ekf__sym_8m_abe119338ba11d7fd166333a3941bc2c4}{x}} 3)) }
