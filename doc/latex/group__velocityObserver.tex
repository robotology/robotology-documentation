\doxysubsubsection{velocity\+Observer}
\hypertarget{group__velocityObserver}{}\label{group__velocityObserver}\index{velocityObserver@{velocityObserver}}
...
The figure below shows a snapshot of the estimated velocity and acceleration along with a comparison between the proposed algorithm and a simple moving average filter\+: \hypertarget{group__tutorial__perceptiveModels_lib_sec}{}\doxysubsubsubsection{\texorpdfstring{Libraries}{Libraries}}\label{group__tutorial__perceptiveModels_lib_sec}
