...
Now from any machine you can rpc to the port \char`\"{}/icub/face/emotions/in\char`\"{} and send high level commands. Be aware that some commands are only available on the latest robots mounting the R\+FE board.


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespaceiCub_1_1skinManager_a5adb5e617574f80720487ad7d406954aa81f7c9d755853bec895ac199f19c6678}{help}}         to display \textcolor{keyword}{this} \mbox{\hyperlink{icub-main_2src_2modules_2CMakeLists_8txt_a74112e17f49315f4063f64db882f6fca}{message}}}
\DoxyCodeLine{}
\DoxyCodeLine{set <part> <emotion>  \mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} a specific emotion \textcolor{keywordflow}{for} a defined part}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} col <color>     \mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} the color of the led}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} brig <brig>       \mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} the brightness of the leds}
\DoxyCodeLine{        !! available only \textcolor{keywordflow}{for} rfe \mbox{\hyperlink{debugFunctions_8cpp_a387aed6ca89cc24e456666d7df7c1fa0}{board}} !!}
\DoxyCodeLine{        the brightness is defined by an integer from 0 to 5, where 0 means led off}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} mask (<col\_leb> <m\_name\_leb> <brig\_leb>) (<col\_reb> <m\_name\_reb> <brig\_reb>) (<col\_mou> <m\_name\_mou> <brig\_mou>) \mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} color, bitmask and brightness \textcolor{keywordflow}{for each} part(leb, reb, mou)}
\DoxyCodeLine{        !! available only \textcolor{keywordflow}{for} rfe \mbox{\hyperlink{debugFunctions_8cpp_a387aed6ca89cc24e456666d7df7c1fa0}{board}} !!}
...
For example (6 9 10 18) means specify which that led 6, 9, 10 and 18 has to be set to on of that specific segment. The L\+E\+Ds on the \mbox{\hyperlink{namespaceiCub}{i\+Cub}} face mounting the rfe board are arranged as follow\+: \begin{DoxyWarning}{Warning}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./cycle.sh: demonstates the face expressions, cycle randomly through a \mbox{\hyperlink{icub-main_2src_2libraries_2ctrlLib_2CMakeLists_8txt_ace2489addfc1fc2af5ae35ff0879adb7}{set}} of expressions.}
