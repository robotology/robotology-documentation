\doxysubsection{face\+Expressions}
\hypertarget{group__icub__faceExpressions}{}\label{group__icub__faceExpressions}\index{faceExpressions@{faceExpressions}}
...
Contains scripts to run the face expressions. At the moment only runs locally.\hypertarget{group__icub__robotscripting_dep_sec}{}\doxysubsubsection{\texorpdfstring{Dependencies}{Dependencies}}\label{group__icub__robotscripting_dep_sec}
None.\hypertarget{group__icub__robotscripting_modules_sec}{}\doxysubsubsection{\texorpdfstring{Instantiated Modules}{Instantiated Modules}}\label{group__icub__robotscripting_modules_sec}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./conf/emotions.ini:\ parameters\ passed\ to\ the\ emotionInterface\ \textcolor{keyword}{module}\ to\ run\ expressions\ on\ "{}classic"{}\ iCub.}
\DoxyCodeLine{./conf/emotions\_rfe.ini:\ parameters\ passed\ to\ the\ emotionInterface\ module\ to\ run\ expressions\ on\ iCub\ mounting\ the\ rfe\ board.}
\DoxyCodeLine{./conf/serialport.ini:\ parameters\ passed\ to\ the\ serial\ device.}

\end{DoxyCode}
\hypertarget{group__icub__faceExpressions_howto_sec}{}\doxysubsubsection{\texorpdfstring{How to run the Application}{How to run the Application}}\label{group__icub__faceExpressions_howto_sec}
...
\begin{DoxyItemize}
\item Face Expressions (face\+Expressions.\+xml). This can run out of the box, since it assumes you have a pc104 and a real \doxylink{namespaceiCub}{i\+Cub}.
\item Face\+Sim (face\+Expressions\+Sim.\+xml). This is the equivalent application to be used with the robot simulator.
\end{DoxyItemize}
...
For example (6 9 10 18) means specify which that led 6, 9, 10 and 18 has to be set to on of that specific segment. The LEDs on the \doxylink{namespaceiCub}{i\+Cub} face mounting the rfe board are arranged as follow\+: \begin{DoxyWarning}{Warning}
Note that the enumeration is 1-\/based in the image but the bitmasks are 0-\/based
\end{DoxyWarning}
\hypertarget{group__icub__faceExpressions_example_sec}{}\doxysubsubsection{\texorpdfstring{Example Instantiation of the Module}{Example Instantiation of the Module}}\label{group__icub__faceExpressions_example_sec}
...
This file can be edited at \doxylink{icub-main_2app_2faceExpressions_2doc_8dox}{app/face\+Expressions/doc.\+dox}
