...
\hypertarget{icub_motor_control_tutorial}{}\label{icub_motor_control_tutorial}\index{Getting accustomed with motor interfaces@{Getting accustomed with motor interfaces}}
This tutorial shows how to get interfaces to control the arm.\hypertarget{icub_tutorial_module_sec_intro}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{icub_tutorial_module_sec_intro}
...
\end{DoxyCode}
\hypertarget{icub_motor_control_tutorial_sec_position}{}\doxysection{\texorpdfstring{Position control}{Position control}}\label{icub_motor_control_tutorial_sec_position}
First do\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ i;}
\DoxyCodeLine{\textcolor{keywordflow}{for}\ (i\ =\ 0;\ i\ <\ \mbox{\hyperlink{namespacepython-motor-control_a4ca50be99ae80d23d05d7dba00eadd07}{jnts}};\ i++)\ \{}
...
where \textquotesingle{}\textquotesingle{}command\+\_\+position\textquotesingle{}\textquotesingle{} is the desired position. This starts a movement of all axes toward the desired position.\hypertarget{icub_motor_control_tutorial_sec_velocity}{}\doxysection{\texorpdfstring{Velocity control}{Velocity control}}\label{icub_motor_control_tutorial_sec_velocity}
...
which accelerates all axes to the velocity described by the vector \textquotesingle{}\textquotesingle{}command\+\_\+velocity\textquotesingle{}\textquotesingle{} (in degrees per second).\hypertarget{icub_motor_control_tutorial_sec_closing}{}\doxysection{\texorpdfstring{Closing the device}{Closing the device}}\label{icub_motor_control_tutorial_sec_closing}
...
To read more about the interfaces that are available in YARP read the online documentation\+: \href{http://eris.liralab.it/yarpdoc/namespaceyarp_1_1dev.html}{\texttt{ http\+://eris.\+liralab.\+it/yarpdoc/namespaceyarp\+\_\+1\+\_\+1dev.\+html}}\hypertarget{icub_tutorial_module_sec_code}{}\doxysection{\texorpdfstring{Code}{Code}}\label{icub_tutorial_module_sec_code}
See code in\+: \doxylink{tutorial__arm_8cpp}{src/motor\+Control\+Basic/tutorial\+\_\+arm.\+cpp} 