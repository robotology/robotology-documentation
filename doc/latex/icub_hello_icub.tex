...
\hypertarget{icub_hello_icub}{}\label{icub_hello_icub}\index{The classic hello world@{The classic hello world}}
...
This program will print the "{}\+Hello i\+Cub"{} message for some times, waiting 0.\+5 seconds at every iteration of the while loop.
...
\DoxyCodeLine{}
\DoxyCodeLine{add\_executable(hello\ \mbox{\hyperlink{icub-tutorials_2src_2anyRobotCartesianInterface_2src_2fakeRobot_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main}}.cpp)}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#\ we\ now\ add\ the\ YARP\ libraries\ to\ our\ project.}}
\DoxyCodeLine{target\_link\_libraries(hello\ \$\{YARP\_LIBRARIES\})}
